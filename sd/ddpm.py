...
if __name__ == "__main__":
    ...
    print(ddpm.timesteps.shape)

    ddpm.get_strength(0.5)

    print(ddpm.timesteps.shape)

    latent = torch.rand(1, 4, 64, 64)
    noisy_samples = ddpm.add_noise(original_samples=latent, timesteps=ddpm.timesteps[0])
    print(noisy_samples.shape)
    
    ddpm.set_inference_timesteps(1000)
    sample = ddpm.step(ddpm.timesteps[50], latent, latent)
    print(sample.shape)
